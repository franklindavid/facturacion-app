...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    if (_store__WEBPACK_IMPORTED_MODULE_0__.store.state.token !== '') {
      axios.post('/api/auth/checkToken', _store__WEBPACK_IMPORTED_MODULE_0__.store.state.token).then(function (res) {})["catch"](function (err) {
        _store__WEBPACK_IMPORTED_MODULE_0__.store.commit('clearToken');
