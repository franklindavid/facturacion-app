...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      userLogged: _reactive_js__WEBPACK_IMPORTED_MODULE_2__.userLogged
    };
  },
  ...
  methods: {
    logout: function logout() {
      ...
      axios.post('/api/auth/logout', _store__WEBPACK_IMPORTED_MODULE_1__.store.state.token).then(function (res) {
        _store__WEBPACK_IMPORTED_MODULE_1__.store.commit('clearToken');
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return axios.post('/api/auth/me', _store__WEBPACK_IMPORTED_MODULE_1__.store.state.token).then(function (res) {
                if (res.data.success) {
                  _reactive_js__WEBPACK_IMPORTED_MODULE_2__.userLogged.user = res.data.user;
                }
              })["catch"](function (err) {
                console.log(err.response.data);
                _reactive_js__WEBPACK_IMPORTED_MODULE_2__.userLogged.user = [];
              });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [_hoisted_4, $data.userLogged ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("h3", _hoisted_5, " Hi , " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.userLogged.user.name), 1
  /* TEXT */
