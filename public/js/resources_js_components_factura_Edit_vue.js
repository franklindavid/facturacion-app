...
var _hoisted_25 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"col-12 mb-2\"><button class=\"btn btn-primary\"><i class=\"fas fa-plus-circle\"></i>Agregar Producto</button></div><div class=\"col-12\"><button type=\"submit\" class=\"btn btn-warning\">Editar</button></div>", 2);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.factura.nit_receptor]])])]), _hoisted_25])], 32
  /* HYDRATE_EVENTS */
  )])])])]);
}
